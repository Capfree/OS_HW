...
/* This struct contains top-level metadata for a directory block. */
struct dirNode
{
    int totalFileNum;           /* # of all files                 */
    int localFileNum;           /* # of files in this block       */
    int prevBlock;              /* block # of prev dirblk         */       
};
...
{
    int db_blocknum;
	//struct dirNode db_dirNode;
    struct filenode db_fnodes[DIRENTRIES];
	//struct dirblock *nextDirBlk;
};

#define isbadfd(n) (((n) < 0) || ((n) >= DIRENTRIES))
//This macro not working for linked list dir
