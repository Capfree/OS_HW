...
syscall send(int pid, message);
syscall sendnow(int pid, message);
...
/* Kernel constants */
#define PREEMPT		TRUE//FALSE 		/* preemptive rescheduling			*/
#define AGING		TRUE//FALSE 	/* queue aging prevents starvation	*/
