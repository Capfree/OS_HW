...
#define PRWAIT      4       /**< process is on sema wait queue           */
#define PRRECV      5       /**< process is blocked while trying to receive a message       */
#define PRSEND      6       /**< process is blocked while trying to send a message          */
...
typedef struct pentry
{
	...
	int msgout;
	qid_typ msgqueue;
	spinlock_t msginlock;           /**< Spinlock to guard msgin         */
	memblk *myblocks;
} pcb;
